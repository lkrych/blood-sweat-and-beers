...
static void test_black_brown_yellow(void)
{

   resistor_value_t actual =
       color_code((resistor_band_t[]){ BLACK, BROWN, YELLOW });
   TEST_ASSERT_EQUAL_UINT16(10, actual.value);
   TEST_ASSERT_EQUAL(KILOOHMS, actual.unit);
}
...
int main(void)
{
   ...
   RUN_TEST(test_black_brown_yellow);
